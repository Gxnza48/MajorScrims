...
import { User, Shield, Zap, Target, TrendingUp, Info, FileEdit, Users, Trophy, FileText } from "lucide-react";
                    ...
                    <div className="space-y-6 lg:col-span-1">
                        ...
                        {isAdmin && (
                            <>
                                ...
                                <Link href="/dashboard/legal" className="block">
                                    <div className="cursor-pointer rounded-2xl border border-white/10 bg-white/[0.03] p-8 transition-colors duration-300 hover:border-primary/35">
                                        <FileText className="mb-6 text-primary" size={32} />
                                        <h4 className="mb-3 text-lg font-bold text-white">Páginas legales</h4>
                                        <p className="text-sm leading-relaxed text-white/60">
                                            Editar los términos del servicio y la política de privacidad que pide
                                            Discord.
                                        </p>
                                    </div>
                                </Link>
